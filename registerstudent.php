    ...
    <div class="container-fluid ">
        ...
        <div class="row align-items-center">
            ...
            <div class="card card-outline card-primary col-10 offset-1 col-lg-6 offset-lg-3 mt-4 mb-3">
                ...
                <div class="card-body">
                    <p class="login-box-msg"><b>Student Registration</b></p>
                    ...
                    <div class="row">
                        ...
                        <div class="input-group mb-3 col-12 col-lg-6">
                            <input type="text" class="form-control" placeholder="Contact Number(Optional)" id="contact">
                        </div>
                        <div class="input-group mb-3 col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-2">
                            <button class="btn btn-primary btn-block" onclick="studentRegister();">Register</button>
                        </div>
                        <div class="col-12 mt-2">
                            <button class="btn btn-danger btn-block">I already have a membership</button>
                        </div>
