                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-bordered  table-hover text-nowrap">
                                ...
                                <tbody>
                                    <?php
                                    $puserrs = Database::search("SELECT * FROM `user` WHERE `user_type_id`='2' AND `email_status_id`='2' AND `login_status_id`='2'");
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary" onclick="sendRegisterEmailT('<?php echo $puserd['id']; ?>');">Send Email</button>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-bordered  table-hover text-nowrap">
                                ...
                                <tbody>
                                    <?php
                                    $suserrs = Database::search("SELECT * FROM `user` WHERE `user_type_id`='2' AND `email_status_id`='1' AND `login_status_id`='2'");
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <?php
                                                    ...
                                                    if ($as == "1") {
                                                    ?>
                                                        <button class="btn btn-dark" onclick="blockuserRT('<?php echo $suserd['id']; ?>')">Block</button>
                                                    <?php
                                                    } else {
                                                    ?>
                                                        <button class="btn btn-dark" onclick="blockuserRT('<?php echo $suserd['id']; ?>')">Unblock</button>
                                                    <?php
                                                    }
                                                    ?>
                                                </td>
