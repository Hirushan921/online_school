                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-success"><b>Verified Teachers</b></h3>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-bordered  table-hover text-nowrap">
                                ...
                                <tbody>
                                    <?php
                                    $luserrs = Database::search("SELECT * FROM `user` WHERE `user_type_id`='2' AND `email_status_id`='1' AND `login_status_id`='1'");
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($as == "1") {
                                                    ?>
                                                        <button class="btn btn-dark" onclick="blockuserMT('<?php echo $luserd['id']; ?>')">Block</button>
                                                    <?php
                                                    } else {
                                                    ?>
                                                        <button class="btn btn-dark" onclick="blockuserMT('<?php echo $luserd['id']; ?>')">Unblock</button>
                                                    <?php
                                                    }
                                                    ?>
                                                </td>
